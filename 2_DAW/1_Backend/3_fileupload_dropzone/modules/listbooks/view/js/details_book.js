function load_users() {
    var jqxhr = $.get("modules/listbooks/controller/controller_books.class.php?loaddetails1=true", function (data) {
...
function pintar_user(data) {
    ...
    province.innerHTML += data[0].province;
