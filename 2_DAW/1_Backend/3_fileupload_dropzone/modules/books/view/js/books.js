...
//Datepicker///////////////////////////
    ...
    $.get( "modules/books/controller/controller_books.class.php?load_country=true",
        function( response ) {
            //console.log(response);
            if(response === 'error'){
                load_countries_v2("resources/ListOfCountryNamesByName.json");
            }else{
                load_countries_v2("modules/books/controller/controller_books.class.php?load_country=true"); //oorsprong.org
            }
    })
...
$.get( "modules/books/controller/controller_books.class.php?load_provinces=true",
    function( response ) {
      $("#province").empty();
      $("#province").append('<option value="" selected="selected">Select province</option>');
...
$.post("modules/books/controller/controller_books.class.php", datos, function(response) {
  //alert(response);
    var json = JSON.parse(response);
